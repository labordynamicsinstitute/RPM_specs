...
cd %{buildroot}
echo '
if [[ ! -z $(tty 2>/dev/null | grep -E "/dev/tty?|/dev/rcons?|/dev/console") ]]
then
 export TMOUT=1200        
fi
' > %{filename}
...
%changelog
* Tue Jul  3 2007 Lars Vilhuber <lars.vilhuber@cornell.edu> - 1.0-2
- Added console identification for Egenera blades
