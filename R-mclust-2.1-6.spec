...
# spec file for R library mclust
#
...
Copyright: See http://www.stat.washington.edu/mclust/license.txt
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - Model-based cluster analysis
...
Author(s)
C. Fraley and A.E. Raftery, Dept. of Statistics,
