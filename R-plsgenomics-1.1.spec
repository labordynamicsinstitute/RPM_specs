...
# spec file for R library plsgenomics
#
...
Summary: R package %{packname} - PLS analyses for genomics
...
Currently, it implements PLS methods for classification with microarray
data and for predicting transcription factor activities from combined
ChIP-chip analysis.

Author(s)
Anne-Laure Boulesteix <boulesteix@stat.uni-muenchen.de>, and
