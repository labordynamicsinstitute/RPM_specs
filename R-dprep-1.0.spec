...
Summary: R package %{packname} - Data preprocessing and visualization functions for classification
...
Author(s)
Edgar Acuna<edgar@cs.uprm.edu> and  Caroline Rodriguez<caroline@math.uprm.edu>
