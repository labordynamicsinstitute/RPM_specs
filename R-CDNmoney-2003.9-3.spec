...
# spec file for R library CDNmoney
#
...
Summary: R package %{packname} - Components of Canadian Monetary Aggregates
...
%description
R package:
Components of Canadian Monetary Aggregates with continuity adjustments.
