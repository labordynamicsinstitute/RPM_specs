...
Summary: R package %{packname} - Generalized Estimation Equation solver
...
Author(s)
Vincent J Carey. Ported to R by Thomas Lumley (versions 3.13 and 4.4)
and Brian Ripley <ripley@stats.ox.ac.uk> (version 4.13).

Gee version 98/1/27, this port 2002-07-03
