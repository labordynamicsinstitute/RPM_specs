...
Summary: R package %{packname} - Analysis of configuration frequencies (CFA)
...
%description
R package:
Analysis of configuration frequencies (simple and repeated measures) plus hierarchical und bootstrap-CFA plus plots
