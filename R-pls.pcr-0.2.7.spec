...
# spec file for R library pls.pcr
#
...
Copyright: Free re-distribution for non-commercial purposes.
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - PLS and PCR functions
