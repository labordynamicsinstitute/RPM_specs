...
# spec file for R library statmod
#
...
Summary: R package %{packname} - Statistical Modeling
...
%description
R package:
Various biostatistical modeling functions including growth curve comparisons, mixed linear models, heteroscedastic regression and Tweedie family generalized linear models.
