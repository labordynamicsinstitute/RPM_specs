...
Summary: R package %{packname} - rcdd (C Double Description for R)
...
see http://www.cs.mcgill.ca/~fukuda/soft/cdd_home/

Author(s)
Charles J. Geyer <charlie@stat.umn.edu> and
