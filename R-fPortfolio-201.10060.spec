...
# spec file for R library fPortfolio
#
...
Copyright: GPL Version 2 or laterLicense: GPL Version 2 or later
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - Financial Software Collection - fPortfolio
BuildRequires: R-base
PreReq: R-base
Requires:  R-fSeries R-fMultivar R-fCalendar R-fBasics
BuildRoot: /var/tmp/%{packname}-buildroot

%description
R package:
fPortfolio from Rmetrics
