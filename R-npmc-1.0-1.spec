...
%description
R package:
Provides simultaneous rank test procedures for the one-way layout without presuming a certain distribution.

Author(s)
Joerg Helms, Ullrich Munzel
