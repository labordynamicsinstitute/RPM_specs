...
Summary: R package %{packname} - ScaLAPACK implementation in R
...
Author(s)
Nagiza F. Samatova <samatovan@ornl.gov>, Srikanth Yoginath <yoginathsb@ornl.gov>, and David Bauer <bauerda@ornl.gov>
