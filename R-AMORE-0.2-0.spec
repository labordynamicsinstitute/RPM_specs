...
Summary: R package %{packname} - A MORE flexible neural network package
...
Author(s)
Manuel Castejón Limas <manuel.castejon@unileon.es>, Joaquín B. Ordieres Meré <joaquin.ordieres@dim.unirioja.es>, Eliseo P. Vergara González <eliseo.vergara@dim.unirioja.es>, Francisco Javier Martínez de Pisón Ascacibar <fjmartin@dim.unirioja.es>, Alpha V. Pernía Espinoza <alpha.pernia@alum.unirioja.es>, Fernando Alba Elías <fernando.alba@unavarra.es>
