...
# spec file for R library bicreduc
#
...
Summary: R package %{packname} - Reduction algorithm for the NPMLE for the distribution function of bivariate interval-censored data
