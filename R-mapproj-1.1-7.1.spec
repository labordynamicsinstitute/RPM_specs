...
# spec file for R library mapproj
#
...
Copyright: Distribution and use for non-commercial purposes only.
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - Map Projections
