...
# spec file for R library lokern
#
...
Summary: R package %{packname} - Kernel Regression Smoothing with Local or Global Plug-in Bandwidth
...
Author(s)
Eva Herrmann <eherrmann@mathematik.tu-darmstadt.de> (F77 & S original);
