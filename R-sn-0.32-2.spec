...
Summary: R package %{packname} - The skew-normal and skew-t distributions
...
distributions, and for fitting them to data, in the scalar and the
multivariate case.
