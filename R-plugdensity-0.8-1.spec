...
# spec file for R library plugdensity
#
...
Summary: R package %{packname} - Plug-in Kernel Density Estimation
...
Author(s)
Eva Herrmann <eherrmann@mathematik.tu-darmstadt.de> (C original);
