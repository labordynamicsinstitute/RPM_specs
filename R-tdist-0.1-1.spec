...
Summary: R package %{packname} - Distribution of a linear combination of independent Student's t-variables
...
Author(s)
Viktor Witkovsky <wiktovsky@savba.sk> and Alexander Savin <savin@savba.sk>
