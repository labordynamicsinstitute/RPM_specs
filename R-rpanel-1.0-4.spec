...
# spec file for R library rpanel
#
...
Summary: R package %{packname} - Simple interactive controls for R using the tcktk library
...
GUI controls for R functions.
Author(s)
Bowman, Bowman, and Crawford
