...
# spec file for R library tripack
#
...
Copyright: R functions: GPL, Fortran code: ACM, free for noncommercial use
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - Triangulation of irregularly spaced data
...
R functions by Albrecht Gebhardt <albrecht.gebhardt@uni-klu.ac.at>.
