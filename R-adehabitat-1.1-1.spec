...
# spec file for R library adehabitat
#
...
Summary: R package %{packname} - Analysis of habitat selection by animals
...
Author(s)
Clément Calenge, contributions from Mathieu Basille
