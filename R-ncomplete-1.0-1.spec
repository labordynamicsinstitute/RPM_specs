...
# spec file for R library ncomplete
#
...
Summary: R package %{packname} - ncomplete
...
Author(s)
Peter J. Rousseeuw, Andreas Christmann <christmann@statistik.uni-dortmund.de>
