...
# spec file for R library princurve
#
...
Copyright: ??? (S original from statlib)
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - Fits a Principal Curve in Arbitrary Dimension
...
Author(s)
S original by Trevor Hastie <trevor@research.att.com>
