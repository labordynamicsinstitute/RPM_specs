...
# spec file for R library Oarray
#
...
Summary: R package %{packname} - Arrays with arbitrary offsets
...
%description
R package:
Generalise the starting point of the array index, eg
to allow x[0, 0, 0] to be the first element of x.
