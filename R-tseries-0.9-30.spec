...
# spec file for R library tseries
#
...
Summary: R package %{packname} - Time series analysis and computational finance
BuildRequires: R-base
PreReq: R-base
Requires:  R-zoo R-quadprog
...
Author(s)
Compiled by Adrian Trapletti <a.trapletti@swissonline.ch>
