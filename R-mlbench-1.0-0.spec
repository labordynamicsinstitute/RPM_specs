...
# spec file for R library mlbench
#
...
Copyright: Free for non-commercial purposes. See the file README and thehelp pages of the data sets for details.
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - Machine Learning Benchmark Problems
...
and Evgenia Dimitriadou <E.Dimitriadou@ci.tuwien.ac.at>.
