...
Summary: R package %{packname} - Multi-state Markov models in continuous time
...
%description
R package:
Functions for fitting continuous-time Markov multi-state
models to categorical processes observed at arbitrary times,
optionally with misclassified responses, and covariates on transition
or misclassification rates.

Author(s)
Christopher H. Jackson <chris.jackson@imperial.ac.uk>
