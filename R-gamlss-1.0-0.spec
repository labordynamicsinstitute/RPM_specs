...
# spec file for R library gamlss
#
...
Summary: R package %{packname} - Collection of functions to fit Generalized Additive Models for Location Scale and Shape and handled gamlss objects.
