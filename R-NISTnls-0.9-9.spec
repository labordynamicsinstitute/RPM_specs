...
# spec file for R library NISTnls
#
...
Copyright: Original pages from NIST web site.  Modifications for R covered byGPL (version 2 or later)
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - Nonlinear least squares examples from NIST
...
Author(s)
original from National Institutes for Standards and Technology (NIST)
