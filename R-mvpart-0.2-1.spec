...
# spec file for R library mvpart
#
...
Copyright: use under GPL2, or see file LICENCE
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - Multivariate partitioning
...
Extensions and adaptations of rpart to mvpart by Glenn De'ath <g.death@aims.gov.au>.

February 2004 version of mvpart
