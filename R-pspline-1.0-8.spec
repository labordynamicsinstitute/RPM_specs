...
# spec file for R library pspline
#
...
Summary: R package %{packname} - Penalized Smoothing Splines
...
Author(s)
S original by Jim Ramsey <ramsay@psych.mcgill.ca>.
