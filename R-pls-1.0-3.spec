...
Summary: R package %{packname} - Partial Least Squares Regression (PLSR) and Principal Component Regression (PCR)
...
regression (PLSR) and principal components regression (PCR).
This package supersedes the pls.pcr package.
