...
# spec file for R library LogicReg
#
...
Summary: R package %{packname} - Logic Regression
...
Author(s)
Charles Kooperberg <clk@fhcrc.org> and Ingo Ruczinski <ingo@jhu.edu>
