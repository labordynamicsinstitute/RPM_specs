...
# spec file for R library glmmML
#
...
Summary: R package %{packname} - Generalized linear models with random intercept
...
%description
R package:
A Maximum Likelihood approach to mixed models.
