...
# spec file for R library SeqKnn
#
...
Summary: R package %{packname} - Sequential KNN imputation method
...
Author(s)
Ki-Yeol Kim and Gwan-Su Yi, Cbio lab., Information and Communications University
