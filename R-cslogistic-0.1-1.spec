...
# spec file for R library cslogistic
#
...
Summary: R package %{packname} - Conditionally Specified Logistic Regression
...
Author(s)
Alejandro Jara Vallejos <Alejandro.JaraVallejos@med.kuleuven.be>  and
