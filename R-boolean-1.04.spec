...
# spec file for R library boolean
#
...
Summary: R package %{packname} - Boolean logit and probit
...
%description
R package:
Partial-observability procedure for testing Boolean hypotheses

Author(s)
Bear F. Braumoeller <bfbraum@fas.harvard.edu>, Jacob Kline <jkline@fas.harvard.edu>
