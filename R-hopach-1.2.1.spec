...
# spec file for R library hopach
#
...
Summary: R package %{packname} - Hierarchical Ordered Partitioning and Collapsing Hybrid (HOPACH)
...
Author(s)
Katherine S. Pollard <kpollard@soe.ucsc.edu>, with
Mark J. van der Laan <laan@stat.berkeley.edu>.
