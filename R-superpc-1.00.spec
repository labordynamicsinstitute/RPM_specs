...
# spec file for R library superpc
#
...
Summary: R package %{packname} - Supervised principal components
...
%description
R package:
Supervised prinical components

Author(s)
Eric Bair,  R. Tibshirani
