...
# spec file for R library maptools
#
...
Copyright: GPL version 2 or later (R and interface code), MIT (shapelib code)
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - tools for reading and handling shapefiles
...
Author(s)
Nicholas J. Lewin-Koh, modified by Roger Bivand <Roger.Bivand@nhh.no>; C code used from shapelib ()
