...
Summary: R package %{packname} - Functional Data Analysis
...
%description
R package:
Analysis of fucntional data, that is data where the basic observation is a function of some sort--an area involving the generalization of the techniques of multivariate data analysis to functional data

Author(s)
Jim Ramsay <ramsay@psych.mcgill.ca>
