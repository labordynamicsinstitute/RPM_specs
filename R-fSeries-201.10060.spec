...
# spec file for R library fSeries
#
...
Summary: R package %{packname} - Financial Software Collection - fSeries
BuildRequires: R-base
PreReq: R-base
Requires:  R-fCalendar R-fBasics
BuildRoot: /var/tmp/%{packname}-buildroot

%description
R package:
fSeries from Rmetrics -
