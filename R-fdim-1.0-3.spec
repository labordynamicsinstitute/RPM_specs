...
Summary: R package %{packname} - Functions for calculating fractal dimension.
...
Author(s)
Fco. Javier Martinez de Pison Ascacibar.  <francisco.martinez@dim.unirioja.es>, Joaquin Ordieres Mere. <joaquin.ordieres@dim.unirioja.es>, Manuel Castejon Limas. <manuel.castejon@dim.unirioja.es>, Fco. Javier de Cos Juez. <francisco-javier.de-cos@dim.unirioja.es>.
