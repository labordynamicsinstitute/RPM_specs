...
# spec file for R library RColorBrewer
#
...
Copyright: Apache-Style Software License
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - ColorBrewer palettes
