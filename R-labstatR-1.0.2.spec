...
# spec file for R library labstatR
#
...
Summary: R package %{packname} - Libreria del Laboratorio di Statistica  con R
...
Author(s)
Stefano M.Iacus <stefano.iacus@unimi.it> and Guido
Masarotto <guido@sirio.stat.unipd.it>
