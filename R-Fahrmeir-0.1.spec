...
# spec file for R library Fahrmeir
#
...
Summary: R package %{packname} - Data from the book "Multivariate Statistical Modelling Based on Generalized Linear Models" by Ludwig Fahrmeir and Gerhard Tutz
...
Modelling Based
on Generalized Linear Models" by
Ludwig Fahrmeir and Gerhard Tutz

Author(s)
compiled by Kjetil Halvorsen
