...
# spec file for R library sandwich
#
...
Summary: R package %{packname} - Robust Covariance Matrix Estimators
...
%description
R package:
Model-robust standard error estimators for time series
