...
# spec file for R library CoCoAn
#
...
Summary: R package %{packname} - Constrained Correspondence Analysis
...
%description
R package:
Two functions to compute correspondence analysis and constrained correspondence analysis
and to make the associated graphical representation.
