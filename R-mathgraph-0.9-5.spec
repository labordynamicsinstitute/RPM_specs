...
# spec file for R library mathgraph
#
...
Summary: R package %{packname} - Directed and undirected graphs
...
Author(s)
Original S code by Patrick J. Burns. Ported to R by Nick Efthymiou
