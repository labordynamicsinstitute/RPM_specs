...
# spec file for R library stepwise
#
...
Summary: R package %{packname} - Stepwise detection of recombination breakpoints
...
Author(s)
Jinko Graham <jgraham@stat.sfu.ca>, Brad McNeney <mcneney@sfu.ca>, Francoise Seillier-Moiseiwitsch <seillier@math.umbc.edu>, R interface by Sigal Blay <sblay@sfu.ca>
