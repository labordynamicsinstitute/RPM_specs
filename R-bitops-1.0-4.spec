...
# spec file for R library bitops
#
...
Summary: R package %{packname} - Functions for Bitwise operations
...
Author(s)
S original by Steve Dutky <sdutky@terpalum.umd.edu>
