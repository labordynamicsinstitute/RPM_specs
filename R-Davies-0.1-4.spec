...
# spec file for R library Davies
#
...
Summary: R package %{packname} - The Davies quantile function
...
%description
R package:
useful functions for the Davies quantile function and the
