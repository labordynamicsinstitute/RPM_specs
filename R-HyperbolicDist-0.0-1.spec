...
# spec file for R library HyperbolicDist
#
...
%define packrel  1
%define rel      1
%define packname HyperbolicDist
%define prefix   /usr
...
Summary: R package %{packname} - The hyperbolic distribution
...
%description
R package:
This package includes the basic functions for the hyperbolic
distribution: probability density function, distribution function,
quantile function, a routine for generating observations from the
hyperbolic, and a function for fitting the hyperbolic distribution to
data.
