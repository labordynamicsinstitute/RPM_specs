...
# spec file for R library grouped
#
...
Summary: R package %{packname} - Regression Analysis of Grouped and Coarse Data
...
Author(s)
Dimitris Rizopoulos <dimitris.rizopoulos@med.kuleuven.be> and Spyridoula Tsonaka <spyridoula.tsonaka@med.kuleuven.be>
