...
Summary: R package %{packname} - Clust Along Chromosomes, a method to call gains/losses in CGH array data
...
Author(s)
Pei Wang <wp57@stat.stanford.edu> , with contributions from Balasubramanian Narasimhan  <naras@stanford.edu>.
