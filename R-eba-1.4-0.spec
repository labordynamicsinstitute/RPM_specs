...
Summary: R package %{packname} - Elimination-By-Aspects (EBA) Models
...
%description
R package:
Fitting and testing probabilistic choice models,
especially the Bradley-Terry-Luce (BTL) model (Bradley & Terry, 1952;
Luce, 1959), elimination-by-aspects (EBA) models (Tversky, 1972),
