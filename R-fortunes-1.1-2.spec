...
# spec file for R library fortunes
#
...
Summary: R package %{packname} - R Fortunes
...
Author(s)
Achim Zeileis, fortune contributions from Torsten Hothorn, Peter
