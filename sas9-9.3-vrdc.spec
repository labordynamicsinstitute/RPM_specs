...
Version: 9.3
Release: 1
Source0: sasv93_local.cfg
Source1: SAS93-desktop.tgz
...
touch %buildroot/usr/local/bin/sas93
...
%post 
ln -sf /opt/SAS_%{version}/SASFoundation/%{version}/sas /usr/local/bin/sas93

%post mkdefault
ln -sf /usr/local/bin/sas93 /usr/local/bin/sas9
ln -sf /usr/local/bin/sas9 /usr/local/bin/sas

%preun

%postun 
rm -f /usr/local/bin/sas93
...
%files desktop
%defattr(755,root,root)
/usr/share/applications/vrdc/SAS93.desktop
