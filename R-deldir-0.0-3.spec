...
# spec file for R library deldir
#
...
Summary: R package %{packname} - Delaunay Triangulation and Dirichlet (Voronoi) Tesselation.
...
or Voronoi tesselation (with respect to the entire plane) of
a planar point set.
