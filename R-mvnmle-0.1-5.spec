...
# spec file for R library mvnmle
#
...
Summary: R package %{packname} - ML estimation for multivariate normal data with missing values.
...
Author(s)
Kevin Gross <gross@stat.wisc.edu>, with help from Douglas Bates
