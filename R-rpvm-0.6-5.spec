...
Summary: R package %{packname} - R interface to PVM (Parallel Virtual Machine)
...
Author(s)
Na (Michael) Li <nali@umn.edu> and
A. J. Rossini <rossini@u.washington.edu>.

Mon, 12 Sep 2005 12:20:36 CDT
