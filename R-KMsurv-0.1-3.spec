...
# spec file for R library KMsurv
#
...
Copyright: GPL version 2.0 or later
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - Data sets from Klein and Moeschberger (1997), Survival Analysis
...
Author(s)
Original by Klein and Moeschberger,
modifications by Jun Yan <jyan@stat.uiowa.edu>
