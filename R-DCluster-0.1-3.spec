...
# spec file for R library DCluster
#
...
Summary: R package %{packname} - Functions for the detection of spatial clusters of diseases
BuildRequires: R-base
PreReq: R-base
Requires:  R-sp R-spdep
...
Author(s)
Virgilio Gómez-Rubio <virgil@uv.es>, Juan Ferrándiz <juan.ferrandiz@uv.es>, Antonio López <antonio.lopez@uv.es>
