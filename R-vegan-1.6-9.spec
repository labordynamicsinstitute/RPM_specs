...
Summary: R package %{packname} - Community Ecology Package
...
%description
R package:
Ordination methods and other useful functions for community and
vegetation ecologists.

Author(s)
Jari Oksanen, Roeland Kindt, Bob O'Hara
