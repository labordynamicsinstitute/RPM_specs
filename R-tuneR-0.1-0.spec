...
Summary: R package %{packname} - Analysis of music
...
Author(s)
Uwe Ligges <ligges@statistik.uni-dortmund.de> with contributions from Andrea Preusser and Claus Weihs.
