...
Summary: R package %{packname} - classes and methods for spatial data
BuildRequires: R-base R-RColorBrewer
PreReq: R-base
...
Author(s)
Edzer J. Pebesma <e.pebesma@geo.uu.nl>, Roger Bivand <Roger.Bivand@nhh.no> and others
