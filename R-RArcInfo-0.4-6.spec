...
# spec file for R library RArcInfo
#
...
Summary: R package %{packname} - Functions to import data from Arc/Info V7.x binary coverages
...
Author(s)
Virgilio Gómez-Rubio <virgilio.gomez@uv.es>
