...
# spec file for R library multidim
#
...
Summary: R package %{packname} - Multidim
...
%description
R package:
multidimensional descriptive statistics: factorial methods and classification

Author(s)
André Carlier & Alain Croquette.
R port by Mathieu Ros <ros@jouy.inra.fr>
& Antoine Lucas
