...
# spec file for R library elasticnet
#
...
Summary: R package %{packname} - Elastic Net Regularization and Variable Selection
...
Author(s)
Hui Zou <hzou@stanford.edu> and Trevor Hastie <hastie@stanford.edu>
