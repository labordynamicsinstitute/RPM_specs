...
# spec file for R library iid.test
#
...
Copyright: GPL version 2 or newer. The use should be acknowledged in publication acknowledgement: .. "results were obtained using iid-test by Benestad (The Norwegian Meteorological Institute and the Norwegian Research Council's RegClim programme)."
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - iid-test
BuildRequires: R-base
PreReq: R-base
Requires:  R-clim.pact
