...
Summary: R package %{packname} - kernel smoothing methods: Bowman & Azzalini (1997)
BuildRequires: R-base
PreReq: R-base
Requires:R-rpanel R-misc3d
...
Author(s)
Adrian W. Bowman and Adelchi Azzalini.
