...
# spec file for R library compositions
#
...
Summary: R package %{packname} - Compositional Data Analysis
...
(e.g. concentrations) in the way proposed by Aitchison.

Author(s)
K. Gerald van den Boogaart <boogaart@uni-greifswald.de>, Raimon Tolosana
