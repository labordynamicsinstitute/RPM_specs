...
# spec file for R library Geneland
#
...
Summary: R package %{packname} - A package for landscape genetics
...
%description
R package:
Detection of spatial structure from genetic data.
