...
# spec file for R library PHYLOGR
#
...
Summary: R package %{packname} - Functions for phylogenetically based statistical analyses
...
Author(s)
Ramón Díaz-Uriarte <rdiaz@cnio.es> and Theodore Garland, Jr <tgarland@facstaff.wisc.edu>, <tgarland@citrus.ucr.edu>
