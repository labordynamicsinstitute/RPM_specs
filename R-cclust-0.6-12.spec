...
# spec file for R library cclust
#
...
Summary: R package %{packname} - Convex Clustering Methods and Clustering Indexes
...
Author(s)
Evgenia Dimitriadou <dimi@ci.tuwien.ac.at>
