...
Summary: R package %{packname} - R in the Political Science Computational Laboratory, Stanford University
...
%description
R package:
new classes and/or methods for discrete data models; e.g., models for counts, ordinal data, item-response theory (IRT) models for binary data, computing highest density regions
