...
# spec file for R library geepack
#
...
Summary: R package %{packname} - Generalized Estimating Equation Package
...
Author(s)
Jun Yan <jyan@stat.uiowa.edu>, Søren Højsgaard <sorenh@agrsci.dk>
