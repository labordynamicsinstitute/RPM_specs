...
# spec file for R library seqinr
#
...
Summary: R package %{packname} - Biological Sequences Retrieval and Analysis
...
Author(s)
Delphine Charif <charif@biomserv.univ-lyon1.fr> and
Jean Lobry <lobry@biomserv.univ-lyon1.fr>
