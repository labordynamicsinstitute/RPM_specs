...
# spec file for R library taskPR
#
...
Summary: R package %{packname} - Task-Parallel R Package
...
Author(s)
Nagiza F. Samatova <samatovan@ornl.gov>, David Bauer <bauerda@ornl.gov>, Srikanth Yoginath <yoginathsb@ornl.gov>
