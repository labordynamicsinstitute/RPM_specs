...
# spec file for R library resper
#
...
Copyright: GNU GPL Version 2 or newer.
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - Sampling from restricted permutations
