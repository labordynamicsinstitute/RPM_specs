...
# spec file for R library normalp
#
...
Summary: R package %{packname} - Package for normal of order p distributions (GED)
...
normal of order p distributions (General Error Distributions)

Author(s)
Angelo M. Mineo <elio.mineo@dssm.unipa.it>
