...
Copyright: Unlimited use and distribution.
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - Data Analysis And Graphics
BuildRequires: R-base
PreReq: R-base
Requires:  R-leaps R-oz
BuildRoot: /var/tmp/%{packname}-buildroot

%description
R package:
various data sets used in examples and exercises in
the book Maindonald, J.H. and Braun, W.J. (2003)  "Data
