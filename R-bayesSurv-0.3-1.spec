...
# spec file for R library bayesSurv
#
...
Summary: R package %{packname} - Bayesian Survival Regression with Flexible Error and Random Effects Distributions
BuildRequires: R-base
PreReq: R-base
Requires:  R-smoothSurv R-sm R-coda
