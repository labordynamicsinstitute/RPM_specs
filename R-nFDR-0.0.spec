...
Summary: R package %{packname} - Nonparametric Estimate of FDR Based on Bernstein Polynomials
...
Author(s)
Zhong Guan <zguan@iusb.edu>, Baolin Wu <baolin@biostat.umn.edu> and Hongyu Zhao <hongyu.zhao@yale.edu>.
