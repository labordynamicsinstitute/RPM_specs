...
Summary: R package %{packname} - Nonparametric Quantile Regression -- Defunct
...
Author(s)
Roger Koenker <rkoenker@uiuc.edu> and Pin Ng <Pin.Ng@NAU.EDU>
