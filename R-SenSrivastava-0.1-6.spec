...
# spec file for R library SenSrivastava
#
...
Summary: R package %{packname} - Datasets from Sen & Srivastava
...
Author(s)
Kjetil Halvorsen, <kjetil@acelerate.com>
