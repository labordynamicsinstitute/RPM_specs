...
# spec file for R library covRobust
#
...
Summary: R package %{packname} - Robust Covariance Estimation via Nearest Neighbor Cleaning
...
Author(s)
Naisyin Wang <nwang@stat.tamu.edu> and
