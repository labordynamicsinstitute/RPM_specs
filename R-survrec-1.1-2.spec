...
# spec file for R library survrec
#
...
Summary: R package %{packname} - Survival analysis for recurrent event data
...
data using Peña-Strawderman-Hollander, Whang-Chang
estimators and MLE estimation under a Gamma Frailty model.

Author(s)
F77 original by Edsel A Peña <pena@stat.sc.edu> and Robert L Strawderman <rls@cornell.edu>. Added Fortran routines, R code and packaged by Juan R González <jrgonzalez@ico.scs.es>.
