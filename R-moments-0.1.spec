...
# spec file for R library moments
#
...
Summary: R package %{packname} - Moments, skewness, kurtosis and related tests
...
Author(s)
Lukasz Komsta <luke@novum.am.lublin.pl>
