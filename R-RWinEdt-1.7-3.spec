...
# spec file for R library RWinEdt
#
...
Copyright: GPL for R-WinEdt; WinEdt is Shareware, see http://www.winedt.com for details.
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - R-WinEdt
