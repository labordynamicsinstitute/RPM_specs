...
%description
R package:
A variety of methods for creating magic squares of any
order greater than 2, and various magic hypercubes.  Includes sundry
magic square tools and examples and is intended as a rebuttal to the
