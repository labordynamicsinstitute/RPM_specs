...
# spec file for R library sgeostat
#
...
Copyright: Original ??, extensions GPL version 2 or newer
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - An Object-oriented Framework for Geostatistical Modeling in S+
...
Author(s)
S original by James J. Majure <majure@iastate.edu> Iowa State University
R port + extensions by Albrecht Gebhardt <albrecht.gebhardt@uni-klu.ac.at>
