...
# spec file for R library mixreg
#
...
Summary: R package %{packname} - Functions to fit mixtures of regressions.
...
%description
R package:
Fits mixtures of one-variable regressions (which has
been described as doing ANCOVA when you don't know the levels).
