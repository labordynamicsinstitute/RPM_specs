...
# spec file for R library assist
#
...
Summary: R package %{packname} - A Suite of S-Plus Functions Implementing Smoothing Splines
...
Author(s)
Yuedong Wang <yuedong@pstat.ucsb.edu>, and
