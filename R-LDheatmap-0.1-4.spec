...
# spec file for R library LDheatmap
#
...
Summary: R package %{packname} - Plots measures of pairwise linkage disequilibria for SNPs
...
Author(s)
Ji-Hyung Shin <jshinb@sfu.ca>, Sigal Blay <sblay@sfu.ca>, Jinko Graham <jgraham@stat.sfu.ca>, Brad McNeney <mcneney@stat.sfu.ca>
