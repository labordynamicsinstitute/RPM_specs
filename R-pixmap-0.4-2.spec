...
# spec file for R library pixmap
#
...
Summary: R package %{packname} - Bitmap Images (``Pixel Maps'')
...
Author(s)
Roger Bivand, Friedrich Leisch and Martin Mächler
