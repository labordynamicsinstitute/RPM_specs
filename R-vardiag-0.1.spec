...
# spec file for R library vardiag
#
...
Summary: R package %{packname} - A package for variogram diagnostics
...
Author(s)
Ernst Glatzer <ernst.glatzer@wu-wien.ac.at>
