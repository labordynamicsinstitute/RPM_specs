...
Copyright: Copyright (C) by Bellcore, non-profit use and redistributionpermitted (see COPYING for details)
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - Interface to the XGobi and XGvis programs for graphical data analysis
