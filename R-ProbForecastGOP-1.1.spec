...
# spec file for R library ProbForecastGOP
#
...
%define packrel  0
%define rel      1
%define packname ProbForecastGOP
%define prefix   /usr
...
Summary: R package %{packname} - Probabilistic Weather Field Forecast using the GOP method
BuildRequires: R-base
PreReq: R-base
Requires:  R-fields R-RandomFields
...
Author(s)
Yulia Gel, Adrian E. Raftery, Tilmann Gneiting, Veronica J. Berrocal
