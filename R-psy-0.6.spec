...
Summary: R package %{packname} - Various procedures used in psychometry
...
%description
R package:
Kappa, ICC, Cronbach alpha, screeplot, PCA and related methods
