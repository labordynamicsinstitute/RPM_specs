...
Summary: R package %{packname} - Multiple Precision Arithmetic
...
%description
R package:
Multiple Precision Arithmetic (big integers and rationals, prime number tests),
"arithmetic without limitations" using the C library gmp.

Author(s)
Antoine Lucas, Immanuel Scholz, Rainer Boehme <rb-gmp@reflex-studio.de>,
