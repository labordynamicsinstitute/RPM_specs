...
Summary: R package %{packname} - Simulation from distributions supported by nested hyperplanes
...
Author(s)
Giovanni Petris <GPetris@Uark.edu> and
Luca Tardella <luca.tardella@@uniroma1.it>; original C code
