...
# spec file for R library Matrix
#
...
Copyright: GPL version 2 or later.This R package includes code from the LDL and Metis packages,which are covered by separate copyrights.  See the file Copyrights fordetails.
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - A Matrix package for R
...
%description
R package:
Classes and methods for numerical linear algebra
