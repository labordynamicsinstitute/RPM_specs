...
Summary: R package %{packname} - COBS -- Constrained B-splines
...
Author(s)
Pin T. Ng <Pin.Ng@nau.edu> and Xuming He, U. Illinois;
R port by Martin Maechler
