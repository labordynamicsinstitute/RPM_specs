...
Summary: R package %{packname} - Analysis of categorical-variable datasets with missing values
...
Author(s)
Ported to R by Ted Harding and Fernando Tusell
