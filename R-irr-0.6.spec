...
Copyright: GNU General Public License version 2 or newer
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - Various Coefficients of Interrater Reliability and Agreement
...
Author(s)
Matthias Gamer <gamer@uni-mainz.de>
