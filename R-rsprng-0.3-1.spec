...
# spec file for R library rsprng
#
...
Summary: R package %{packname} - R interface to SPRNG (Scalable Parallel Random Number Generators)
...
%description
R package:
Provides interface to SPRNG APIs, and examples and
documentation for its use.

Author(s)
Na (Michael) Li <nali@umn.edu>

$Date: 2004/02/14 04:51:52 $
