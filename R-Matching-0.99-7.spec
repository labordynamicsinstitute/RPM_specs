...
# spec file for R library Matching
#
...
Copyright: GPL2 or newer as long as authorship of this code is made clear
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - Multivariate and Propensity Score Matching with Automated Balance Search
...
A variety of univariate and multivariate tests to determine if balance
