...
# spec file for R library latticeExtra
#
...
Summary: R package %{packname} - Extra Graphical Displays based on lattice
...
%description
R package:
Generic function and standard methods for Trellis-based displays
