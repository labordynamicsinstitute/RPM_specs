...
Copyright: See file COPYING for license information
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - Rice Wavelet Toolbox wrapper
...
Author(s)
P. Roebuck <roebuck@mdanderson.org>, Rice University's DSP group
