...
Copyright: GPL version 2.  See COPYRIGHT.svm.cpp for thecopyright of the svm C++ code.
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - Misc Functions of the Department of Statistics (e1071), TU Wien
...
Author(s)
Evgenia Dimitriadou, Kurt Hornik, Friedrich Leisch,
