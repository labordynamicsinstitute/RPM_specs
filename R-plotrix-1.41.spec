...
# spec file for R library plotrix
#
...
Summary: R package %{packname} - Various plotting functions
...
%description
R package:
Pie, radial and Gantt charts, specialized barplots,
soil texture plot, various labeling and color scaling functions

Author(s)
Jim Lemon <jim.lemon@uts.edu.au>, Ben Bolker <bolker@zoo.ufl.edu>,
Sander Oom <sander@oomvanlieshout.net>
