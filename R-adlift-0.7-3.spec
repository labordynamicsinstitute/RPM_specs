...
# spec file for R library adlift
#
...
Summary: R package %{packname} - An adaptive lifting scheme algorithm
...
Author(s)
Matt Nunes <matt.nunes@bristol.ac.uk>
Marina Popa <Marina.Popa@bristol.ac.uk>
