...
Summary: R package %{packname} - Functions for handling dates
...
Author(s)
Terry Therneau <therneau@mayo.edu>.  R port by Thomas Lumley
<thomas@biostat.washington.edu>, Kjetil Halvorsen <khal@alumni.uv.es>,
and Kurt Hornik <Kurt.Hornik@R-project.org>.
