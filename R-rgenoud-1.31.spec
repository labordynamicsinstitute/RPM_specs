...
# spec file for R library rgenoud
#
...
Summary: R package %{packname} - R version of GENetic Optimization Using Derivatives
...
Author(s)
Walter R. Mebane, Jr. <wrm1@cornell.edu>,
Jasjeet Singh Sekhon <jasjeet_sekhon@harvard.edu>
