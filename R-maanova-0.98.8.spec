...
# spec file for R library maanova
#
...
Summary: R package %{packname} - Tools for analyzing Micro Array experiments
...
Author(s)
Hao Wu <hao@jax.org>, with ideas from Gary Churchill, Katie Kerr and Xiangqin Cui
