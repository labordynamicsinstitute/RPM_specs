...
Copyright: Unclear (Fortran) -- code in Statlib's ./S/adapt
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - adapt -- multidimensional numerical integration
...
Author(s)
FORTRAN by Alan Genz, S by Mike Meyer, R by Thomas Lumley and Martin Maechler
