...
# spec file for R library gpclib
#
...
Copyright: Free for non-commercial use; commercial use prohibited (see the files `gpc.c' and `gpc.h' for details)
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - General Polygon Clipping Library for R
...
Author(s)
Roger D. Peng <rpeng@jhsph.edu>; GPC library by Alan Murta
