...
Summary: R package %{packname} - Maximum kernel likelihood estimation
...
%description
R package:
Package to compute the maximum kernel likelihood estimator (MKLE) for mu.
