...
# spec file for R library diamonds
#
...
Copyright: Public Domain, unlimited distribution
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - Analysis and sampling grids from diamond partitions
