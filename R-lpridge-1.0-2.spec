...
# spec file for R library lpridge
#
...
Summary: R package %{packname} - Local Polynomial (Ridge) Regression
...
Author(s)
Burkhardt Seifert <seifert@ifspm.unizh.ch> (S original);
