...
# spec file for R library RScaLAPACK
#
...
Copyright: Free.  See COPYING for details.
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - A seamless interface to perform parallel computation on linear algebra problems using the ScaLAPACK library.
...
Author(s)
Nagiza F. Samatova <samatovan@ornl.gov>, Srikanth Yoginath <yoginathsb@ornl.gov>, David Bauer <bauerda@ornl.gov> and Guruprasad Kora <koragh@ornl.gov>
