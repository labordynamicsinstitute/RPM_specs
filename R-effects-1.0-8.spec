...
# spec file for R library effects
#
...
Summary: R package %{packname} - Effect Displays for Linear and Generalized Linear Models
...
Author(s)
John Fox <jfox@mcmaster.ca>. I am grateful to Robert Andersen, David Firth, and
