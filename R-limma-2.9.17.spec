...
Summary: R package %{packname} - Linear Models for Microarray Data
...
Author(s)
Gordon Smyth <smyth@wehi.edu.au> with contributions from Matt Ritchie <mritchie@wehi.edu.au>, Jeremy Silver, James Wettenhall <wettenhall@wehi.edu.au>, Natalie Thorne, Mette Langaas and Egil Ferkingstad
...
#%{prefix}/bin/R CMD check --no-examples %{packname}
