...
Summary: R package %{packname} - Tools for analyzing QTL experiments
...
Author(s)
Karl W Broman <kbroman@jhsph.edu> and Hao Wu <haowu@jax.org>, with ideas from Gary Churchill and Saunak Sen and contributions from Brian Yandell
