...
# spec file for R library hier.part
#
...
Summary: R package %{packname} - Hierarchical Partitioning
...
Author(s)
Chris Walsh <Chris.Walsh@sci.monash.edu.au> and
Ralph MacNally <Ralph.MacNally@sci.monash.edu.au>
