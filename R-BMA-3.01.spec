...
Summary: R package %{packname} - Bayesian Model Averaging
...
Author(s)
Adrian Raftery <raftery@stat.washington.edu>, Jennifer Hoeting, Chris Volinsky, Ian Painter
