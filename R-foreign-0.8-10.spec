...
# spec file for R library foreign
#
...
Summary: R package %{packname} - Read Data Stored by Minitab, S, SAS, SPSS, Stata, Systat, dBase, ...
...
Author(s)
R-core members, Saikat DebRoy <saikat@stat.wisc.edu>,
Roger Bivand <Roger.Bivand@nhh.no> and others:
see COPYRIGHTS file in the sources.
