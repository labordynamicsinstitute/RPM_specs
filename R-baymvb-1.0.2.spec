...
# spec file for R library baymvb
#
...
Summary: R package %{packname} - Bayesian analysis of multivariate binary data
...
%description
R package:
This package fits multivariate binary data
