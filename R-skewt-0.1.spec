...
Summary: R package %{packname} - The Skewed Student-t Distribution
...
Author(s)
Robert King, <Robert.King@newcastle.edu.au>, with contributions from Emily Anderson <emily.anderson@newcastle.edu.au>.
