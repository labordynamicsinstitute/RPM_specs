...
# spec file for R library spectrino
#
...
Copyright: Lesser GPL Version 2 or later.
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - Spectra organizer, visualization and data extraction
