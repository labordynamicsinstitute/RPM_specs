...
# spec file for R library setRNG
#
...
Summary: R package %{packname} - Set (normal) random number generator and seed
...
%description
R package:
Set reproducible random number generator in R and S.
