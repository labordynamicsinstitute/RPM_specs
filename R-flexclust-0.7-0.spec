...
# spec file for R library flexclust
#
...
Summary: R package %{packname} - Flexible Cluster Algorithms
...
Author(s)
Friedrich Leisch, parts based on code by Evgenia Dimitriadou
