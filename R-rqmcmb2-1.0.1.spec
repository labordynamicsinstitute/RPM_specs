...
# spec file for R library rqmcmb2
#
...
Summary: R package %{packname} - Markov Chain Marginal Bootstrap for Quantile Regression
...
Author(s)
Maria Kocherginsky <mkocherg@uchicago.edu>, Xuming He <x-he@uiuc.edu>
