...
Copyright: GPL version 2.0
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - Independent Component Analysis using Maximum Likelihood
