...
# spec file for R library locfit
#
...
Copyright: Free for non-commercial use, see the file COPYRIGHT for details
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - Local Regression, Likelihood and Density Estimation.
...
Author(s)
Catherine Loader <catherine@laplace.stat.cwru.edu>
