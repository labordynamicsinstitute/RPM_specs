...
Copyright: Fortran code: ACM, free for non-commercial use, R functions GPL
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - Interpolation of irregularly spaced data
