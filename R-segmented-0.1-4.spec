...
# spec file for R library segmented
#
...
Summary: R package %{packname} - Segmented relationships in regression models
...
%description
R package:
Functions to estimate break-points of segmented
relationships in regression models (GLMs)
