...
# spec file for R library mvoutlier
#
...
Summary: R package %{packname} - Multivariate outlier detection based on robust methods
BuildRequires: R-base
PreReq: R-base
Requires:  R-st R-rrcov
BuildRoot: /var/tmp/%{packname}-buildroot

%description
R package:
This packages was made for outlier detection using robust estimations
of location and covariance structure.

Author(s)
Moritz Gschwandtner <e0125439@student.tuwien.ac.at> and
