...
# spec file for R library verification
#
...
Summary: R package %{packname} - Forecast verification utilities.
BuildRequires: R-base
PreReq: R-base
Requires:  R-waveslim R-fields
BuildRoot: /var/tmp/%{packname}-buildroot

%description
R package:
This package contains utilities for verification of discrete and probabilistic forecasts.

Author(s)
NCAR- Research Application Program
