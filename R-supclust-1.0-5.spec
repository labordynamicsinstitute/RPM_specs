...
# spec file for R library supclust
#
...
Summary: R package %{packname} - Supervised Clustering of Genes
...
Author(s)
Marcel Dettling and Martin Maechler <maechler@stat.math.ethz.ch>
