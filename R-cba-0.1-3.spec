...
Copyright: GNU GENERAL PUBLIC LICENSE Version 2 (execpt where otherwise noted)
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - Clustering for Business Analytics - Miscellaneous functions.
...
%description
R package:
Implements clustering techniques such as Proximus and Rock, utility functions for efficient computation of cross distances.
