...
Summary: R package %{packname} - Multiple Fractional Polynomials
...
Author(s)
Gareth Ambler <gareth@stats.ucl.ac.uk>, with
contributions from Axel Benner <benner@dkfz.de>
