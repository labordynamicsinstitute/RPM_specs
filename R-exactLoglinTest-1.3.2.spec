...
# spec file for R library exactLoglinTest
#
...
%define packrel  0
%define rel      1
%define packname exactLoglinTest
%define prefix   /usr
...
Summary: R package %{packname} - Monte Carlo Exact Tests for Log-linear models
