...
# spec file for R library GPArotation
#
...
Copyright: GPL Version 2. See the LICENSE file for details.
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - GPA Factor Rotation
