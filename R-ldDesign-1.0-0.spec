...
# spec file for R library ldDesign
#
...
Summary: R package %{packname} - Design of experiments for detection of linkage disequilibrium
...
Author(s)
Rod Ball <rod.ball@forestresearch.co.nz>
