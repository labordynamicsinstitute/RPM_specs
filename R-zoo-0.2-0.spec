...
Summary: R package %{packname} - Z's ordered observations
...
%description
R package:
A class with methods for totally ordered indexed observations
such as irregular time series.
