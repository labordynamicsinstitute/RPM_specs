...
# spec file for R library RSvgDevice
#
...
Summary: R package %{packname} - An R SVG graphics device.
...
%description
R package:
A graphics device for R that uses the new w3.org xml
standard for Scalable Vector Graphics.

Author(s)
T Jake Luciani <jakeluciani@yahoo.com>
