...
# spec file for R library geometry
#
...
Copyright: Qhull copyright notice (original Qhull sources), GPL version 2 or newer (all other files)
URL: http://cran.r-project.org/contrib
Group: Applications/Math
Summary: R package %{packname} - Mesh generation and surface tesselation
