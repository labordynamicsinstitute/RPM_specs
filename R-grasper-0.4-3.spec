...
# spec file for R library grasper
#
...
%description
R package:
GRASP for R uses generalized regressions analyses to automate the production of spatial predictions.

Author(s)
F. Fivaz, A. Lehmann, J.R. Leathwick, J.McC. Overton
