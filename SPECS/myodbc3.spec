...
%define ODBC_DM_PATH_ARG --with-unixODBC=$HOME/odbc-32bit/inst/unixODBC
%define MYSQL_PATH_ARG   --with-mysql-path=$HOME/odbc-32bit/inst/mysql-server-gpl
%define QT_PATH_ARG      --with-qt-dir=$HOME/odbc-32bit/inst/qt
%define EXTRA_XLIBS      -L/usr/X11R6/lib -lXcursor -lXext -lX11 -lm -ldl -lpthread
