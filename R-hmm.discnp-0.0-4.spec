...
# spec file for R library hmm.discnp
#
...
Summary: R package %{packname} - Hidden Markov models with discrete non-parametric observation distributions.
...
Author(s)
Rolf Turner <rolf@math.unb.ca> and Limin Liu.
